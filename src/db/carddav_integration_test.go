...
func TestCardDAVListAndHelpers(t *testing.T) {
	...
	card.SetValue(vcard.FieldNickname, "Ally")
	card.SetValue(vcard.FieldOrganization, "Acme")
	card.SetValue(vcard.FieldTitle, "Engineer")
	card.SetValue(vcard.FieldBirthday, "2000-01-02")
	card.SetValue(vcard.FieldAnniversary, "2005-01-02")
	card.SetValue(vcard.FieldGender, "F")
	...
	card.Add(vcard.FieldEmail, &vcard.Field{Value: "alice.home@example.com", Params: vcard.Params{vcard.ParamType: []string{"home"}}})
	card.Add(vcard.FieldTelephone, &vcard.Field{Value: "+1 555 0000", Params: vcard.Params{vcard.ParamType: []string{"cell"}}})
	card.Add(vcard.FieldTelephone, &vcard.Field{Value: "+1 555 1111", Params: vcard.Params{vcard.ParamType: []string{"fax"}}})
	card.Add(vcard.FieldPhoto, &vcard.Field{Value: "dGVzdA==", Params: vcard.Params{vcard.ParamType: []string{"jpg"}}})
	card.Add(vcard.FieldURL, &vcard.Field{Value: "https://example.com"})
	card.SetValue(vcard.FieldNote, "Notes")
	card.Add(vcard.FieldAddress, &vcard.Field{Value: ";;Main Street;Town;Region;12345;Country", Params: vcard.Params{vcard.ParamType: []string{"home"}}})
