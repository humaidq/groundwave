...
DROP VIEW IF EXISTS contacts_due;
DROP VIEW IF EXISTS contact_view;

DROP FUNCTION IF EXISTS link_all_qsos_to_contacts();
DROP FUNCTION IF EXISTS link_qso_to_contact(UUID);
DROP FUNCTION IF EXISTS export_adif(DATE, DATE);
DROP FUNCTION IF EXISTS qso_to_adif(UUID);
DROP FUNCTION IF EXISTS contact_etag(UUID);
DROP FUNCTION IF EXISTS vcard_uid(UUID);
DROP FUNCTION IF EXISTS get_or_create_tag(TEXT);
...
DROP FUNCTION IF EXISTS clean_contact();
DROP FUNCTION IF EXISTS clean_qso();
...
DROP TYPE IF EXISTS ant_path;
DROP TYPE IF EXISTS qso_complete;
DROP TYPE IF EXISTS qso_upload_status;
DROP TYPE IF EXISTS qsl_via;
DROP TYPE IF EXISTS qsl_sent_status;
DROP TYPE IF EXISTS qsl_status;
